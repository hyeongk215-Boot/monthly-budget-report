window.I18N = {
  ko: {
    ...
    targetProfitHeading: "목표영업이익(한국식) 설정",
    targetProfitDesc: "법인 산하 지점별 월간 목표영업이익을 입력합니다. 실적분석의 목표실적 관리표에서 회계관리의 PL(한국) 영업이익 실적과 비교해 달성률을 계산합니다. 지점이 없는 법인은 해당 지점 한 줄만 입력하세요.",
    colTargetProfitCny: "목표영업이익 (CNY)",
    saveTargetProfitBtn: "목표영업이익 저장",
  ...
  zh: {
    ...
    targetProfitHeading: "目标营业利润(韩国式)设置",
    targetProfitDesc: "请填写法人下属各分公司的月度目标营业利润。实绩分析的目标实绩管理表会将其与会计管理PL(韩国)的营业利润实际数对比计算达成率。没有分公司细分的法人，只需填写一行即可。",
    colTargetProfitCny: "目标营业利润 (CNY)",
    saveTargetProfitBtn: "保存目标营业利润",
